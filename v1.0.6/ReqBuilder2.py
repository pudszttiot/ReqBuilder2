...
class PipreqsWorker(QThread):
    ...
    def run(self):
        ...
        try:
            ...
            # Determine platform and suppress terminal window
            if sys.platform == "win32":
                ...
                process = subprocess.run(cmd, stdout=subprocess.DEVNULL, stderr=subprocess.PIPE, text=True, encoding="utf-8")
...
class PipreqsGUI(QWidget):
    ...
    def select_directory(self):
        ...
        if project_dir:
            ...
            self.status_label.setStyleSheet("QLabel#status_label { color: green; }")
        else:
            self.status_label.setText("No directory selected.")
            
            # Change status label color to red (no directory selected)
            self.status_label.setStyleSheet("QLabel#status_label { color: red; }")
    ...
    def generate_requirements(self):
        ...
        # Change status label color to green (successful directory selection)
        self.status_label.setStyleSheet("QLabel#status_label { color: orange; }")
    ...
    def clear_output(self):
        ...
        # Change status label color to green (successful directory selection)
        self.status_label.setStyleSheet("QLabel#status_label { color: #0078d7; }")
    ...
    def check_for_updates(self):
        ...
        # Change status label color to green (successful directory selection)
        self.status_label.setStyleSheet("QLabel#status_label { color: #DAA520; }")
